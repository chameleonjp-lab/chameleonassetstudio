...
| `APP_2D_EDITION_SPEC.md` *(予定)* | A3(2D), PF4(2D), P5 | A4, A2 | 一部（`features/F-2D-01`〜`12` で 2D パイプラインの大半を機能単位で具体化。エディション文書としての統合は未着手） |
