...
| `APP_3D_EDITION_SPEC.md` *(予定)* | A3(3D), PF4(3D), P5 | A4, A2 | 一部（`features/F-3D-01`/`03`/`05`/`06`/`07` で入口・確認面・`T-DONE-4` を具体化。残り 10 機能とエディション文書の統合は未着手） |
