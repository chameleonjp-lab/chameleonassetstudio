...
作成日: 2026-07-16
状態: `A+B+X accepted / implementation in progress / Draft PR #100`
...
2026-07-16にaccepted範囲のproduct code Draft PR #100を開始した。size validator、矩形・自由size UI、現行6種の明示template fixture、任意character body Part、unit test、E2E、user guide、実装報告を同じbranchで扱う。shape / text、Family / Variant、schema、version、migration、保存形式、export形式は変更しない。
