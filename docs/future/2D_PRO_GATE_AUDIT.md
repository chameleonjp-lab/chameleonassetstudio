...
| 現在のopen PR | 0件。PR #270はmainへmerge済み。 |
...
| Group 23監査PR | PR #266で監査記録、PR #267でPR #266マージ後状態、PR #268でPR #267マージ後状態、PR #269でPR #268マージ後状態、PR #270でPR #269マージ後状態をmainへ反映済み。2D Pro Gate自体は未完了。 |
