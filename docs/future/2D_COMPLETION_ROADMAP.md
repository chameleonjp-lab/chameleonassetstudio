...
| `2D-2-IMPORT-OPTIONAL` | 判断必須 | SVG、GIF、APNG、Aseprite、PSD、OpenRaster、Kritaをeditable / rasterized / reference-only / unsupportedのどれにするか決める。ADR-0016で分類済み。ADR-0019 / PR #135のsource MIME / Asset 0.2.0契約補正はmainへmerge済み。1A + 2A + 3A / ADR-0020のSlice E UI / safety / decodeを製品実装中。 |
...
| 11 | `2D-2-IMPORT-GATE` + `2D-2-IMPORT-OPTIONAL` + `2D-2-AI-BOUNDARY` | PNG / JPEG / WebP、連番、sprite sheet、tileset、既知atlas bundleの取り込みと、任意形式・AI境界のADR判断を行う。 | Fable5または人間判断 + Codex実装 / docs | 10 | 判断必須項目はADR後のみ | in progress | 契約監査PR #124、Slice A PR #125、Slice B PR #126、Slice C PR #127/#128、Slice D PR #129、Slice D closeout PR #133、Slice E source契約補正PR #135はmainへmerge済み。Slice E製品実装は人間承認1A + 2A + 3A / ADR-0020に従い、新規Asset入口だけのSVG安全rasterize、GIF / APNG最大16frame decode・fallback・loss / unsupported表示を実装中。`2D-2-IMPORT-OPTIONAL` はGate後へ移動しない。 |
