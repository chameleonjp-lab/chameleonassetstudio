...
D2は`implemented / CI-passed / independently-verified / merged`である。D3は`contract accepted / product implementation not started`である。B2、D4、物理iPhone Safari、Group 12完了判定は未完了のまま維持する。
