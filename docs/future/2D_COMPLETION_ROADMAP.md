...
| 12 | `2D-3-TIMELINE` + `2D-3-RIG` | frame animation、onion skin、可変時間、loop、event、part parent、pivot、bind pose、rotation / scale、part replace、簡易rig、frame bake、rig flipを実装する。 | Codex。新しいデータ意味はFable5または人間判断 | 8B、関連2D-1A契約 | 2D-2 と条件付き並行可 | public service + Slice A merged + Slice C merged + B1 accepted | 契約監査PR #146、計測資産PR #147、Pages配信PR #148 / #149、T1 Slice A PR #153 merge `e8fac95`、P1 Slice C PR #154 merge `1c700e7`をmainへ反映した。2026-07-23の人間判断で正式B0の4端末収集を保留し、H3を問題発生時の診断手段へ切り替えた。ADR-2026-07-24-027でA1を採用し、B1の座標修正・構造preflight・独立rig反転コピー・完全ID remap・保存 / reload / parityを先行可能とした。B2のH3数値、資源上限、実機product-path、Group 12完了判定は保留する。正本は`2D_3_TIMELINE_RIG_PLAN.md`と`2D_3_H3_MEASUREMENT_PROTOCOL.md`。ADR-0010のcollider override / polygonはGroup 13へ残す。 |
