...
| 11 | `2D-2-IMPORT-GATE` + `2D-2-IMPORT-OPTIONAL` + `2D-2-AI-BOUNDARY` | PNG / JPEG / WebP、連番、sprite sheet、tileset、既知atlas bundleの取り込みと、任意形式・AI境界のADR判断を行う。 | Fable5または人間判断 + Codex実装 / docs | 10 | 判断必須項目はADR後のみ | in progress | 契約監査PR #124、Slice A PR #125、Slice B PR #126、Slice C PR #127/#128、Slice D PR #129はmainへmerge済み。PR #129 final head `5b98b24`のCI Run #415は全成功、独立read-only reviewは`BLOCKER 0 / MUST 0 / SHOULD 2 / NOTE 1`（非Opus）。SHOULD 2件をcloseout補修し、次はSlice Eを直列で進める。`2D-2-IMPORT-OPTIONAL` はGate後へ移動しない。 |
