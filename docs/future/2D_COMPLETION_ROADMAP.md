...
| 15 | `2D-4-CORE` + `2D-4-SHEET` + `2D-4-SCALE` | 共通export core、決定的再出力、fixed grid sheet、packed atlas、trim、padding、multi-page、1x / 2x / 3x、scale、extrudeを固定する。 | Fable5契約固定 + Codex + Opus 4.8 必須 review | 9、14 | SHEET実装後にSCALEへ進む。 | accepted: G15-C1 A + G15-C2 A + G15-C3 A / implemented: 2D-4-CORE / CI-passed / independently-verified / implementing: 2D-4-SHEET | PR #229 / #231 / #232 / #233 / #235をmainへ反映し、G15-H1〜H3 Aでmanifest path / version、packed tie-break、page境界・上限、命名、丸め規則、fixture・unit・CI証拠を固定した。COREはCI Run #707とartifact、固定head独立確認を完了。最新main `4715a73aa1e7cc91bea1444fbbe30e5cad20bbe1`からSHEETを実装中で、既存Atlas `0.1.0`、legacy ZIP、現行の理由付き拒否は維持する。進捗は16/27のまま。 |
