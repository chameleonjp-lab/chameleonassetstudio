...
| 12 | `2D-3-TIMELINE` + `2D-3-RIG` | frame animation、onion skin、可変時間、loop、event、part parent、pivot、bind pose、rotation / scale、part replace、簡易rig、frame bake、rig flipを実装する。 | Codex。新しいデータ意味はFable5または人間判断 | 8B、関連2D-1A契約 | 2D-2 と条件付き並行可 | public service + Slice A/C/B1/D1-D4 merged and independently verified / D1-D4 physical Safari verified / B2 and T1/P1/B1 physical Safari Gate pending | 契約監査PR #146、計測資産PR #147、Pages配信PR #148 / #149、T1 Slice A PR #153、P1 Slice C PR #154、R1 Slice B1 PR #157、D1 PR #201、D2 PR #204をmainへ反映した。D3はPR #206 final head `ac84b8c`、merge `3081495`、CI Run #610全成功、固定headの3方向独立review `BLOCKER 0 / MUST 0 / SHOULD 0`として完了した。ADR-2026-07-29-031でD4のA1+B1+C1を承認し、契約PR #208 merge `ea67920`で実装前Gateを満了した。D4はPR #209 final head `16f5ae2`、merge `5e25d0d`、CI Run #623全成功、固定headの3方向独立review `BLOCKER 0 / MUST 0 / SHOULD 0`として完了した。D1〜D4の物理Safari確認は完了した。B2のH3数値、資源上限、実機product-path、T1 / P1 / B1の物理iPhone / iPad Safari、Group 12完了判定は保留する。正本は`2D_3_TIMELINE_RIG_PLAN.md`と`2D_3_H3_MEASUREMENT_PROTOCOL.md`。ADR-0010のcollider override / polygonはGroup 13へ残す。 |
