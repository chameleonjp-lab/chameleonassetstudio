...
| 11 | `2D-2-IMPORT-GATE` + `2D-2-IMPORT-OPTIONAL` + `2D-2-AI-BOUNDARY` | PNG / JPEG / WebP、連番、sprite sheet、tileset、既知atlas bundleの取り込みと、任意形式・AI境界のADR判断を行う。 | Fable5または人間判断 + Codex実装 / docs | 10 | 判断必須項目はADR後のみ | in progress | 契約監査PR #124、Slice A PR #125、Slice B PR #126、Slice C PR #127/#128はmainへmerge済み。PR #128 final treeのCI Run #413は全成功、独立read-only reviewは`BLOCKER 0 / MUST 0 / SHOULD 0 / NOTE 0`（非Opus）。Slice D開始監査と人間承認を経てADR-0018をacceptedとし、現在はTileset + Chameleon Atlas意味上roundtripを進め、以後Slice Eを直列で進める。`2D-2-IMPORT-OPTIONAL` はGate後へ移動しない。 |
