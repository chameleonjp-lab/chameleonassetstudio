...
Group 12の詳細契約は`2D_3_TIMELINE_RIG_PLAN.md`を正本とする。T1 / R1 / P1の中核はPR #146 final head `20871f7`、merge `cb21ea4`でADR-0021〜0023へ反映した。H1=E1、H2=L1、H3=M1を2026-07-22に追加人間承認し、計測準備PR #147、Pages配信分離PR #148 / #149、T1 Slice A PR #153、P1 Slice C PR #154をmainへ反映した。2026-07-23の人間判断により正式B0を保留し、H3の数値budget、warning、hard capを先取りしない。R1 Slice B1はPR #157、Slice D1はPR #201、D2はPR #204で完了した。ADR-2026-07-29-030のD3はPR #206 final head `ac84b8c2d6141f6353c3e07dbb2dbfae9a2f5c98`、merge `3081495a979d10176a05eb2907e7cede55cc8c9a`、CI Run #610全成功、固定headの3方向独立review `BLOCKER 0 / MUST 0 / SHOULD 0`を経て完了した。ADR-2026-07-29-031でD4のA1+B1+C1を承認し、基準Frameと対象Frameを重ね、対象Frame全体を手動移動し、確定前はUI-only、確定時は1 History、不足dataは自動生成せず拒否する契約を固定した。D4製品実装は本docs-only決定PRのmerge後に別Draft PRで開始する。B2とGroup 12 closeoutは保留し、ADR-0010のcollider override / polygonはGroup 13のまま維持する。

PR #203 / #205のmergeでD2 / D3の実装前Gateを満了し、PR #204 / #206で両Sliceを`implemented / CI-passed / independently-verified / merged`としてcloseoutした。D4は契約承認済み・製品未着手である。B2、物理iPhone SafariのGroup 12 closeout Gateは未完了のまま維持する。

現在の実装前GateはD4である。ADR-2026-07-29-031を反映する本docs-only決定PRがmainへmergeされるまで、D4製品コード、test、UIの実装を開始しない。
...
| 12 | `2D-3-TIMELINE` + `2D-3-RIG` | frame animation、onion skin、可変時間、loop、event、part parent、pivot、bind pose、rotation / scale、part replace、簡易rig、frame bake、rig flipを実装する。 | Codex。新しいデータ意味はFable5または人間判断 | 8B、関連2D-1A契約 | 2D-2 と条件付き並行可 | public service + Slice A/C/B1/D1-D3 merged and independently verified / D4 contract accepted, product implementation not started / B2 pending | 契約監査PR #146、計測資産PR #147、Pages配信PR #148 / #149、T1 Slice A PR #153、P1 Slice C PR #154、R1 Slice B1 PR #157、D1 PR #201、D2 PR #204をmainへ反映した。D3はPR #206 final head `ac84b8c`、merge `3081495`、CI Run #610全成功、固定headの3方向独立review `BLOCKER 0 / MUST 0 / SHOULD 0`として完了した。ADR-2026-07-29-031でD4のA1+B1+C1を承認し、対象Frame全体の手動移動、UI-only draft、1 History、不足data拒否を固定した。D4製品実装は本docs-only決定PRのmerge後に開始する。B2のH3数値、資源上限、実機product-path、物理iPhone Safari、Group 12完了判定は保留する。正本は`2D_3_TIMELINE_RIG_PLAN.md`と`2D_3_H3_MEASUREMENT_PROTOCOL.md`。ADR-0010のcollider override / polygonはGroup 13へ残す。 |
...
PR #53・PR #55は先行merge済みのためrevertしない。PR #53の`2D-1B-*`再監査・補修はPR #70〜#91で完了し、`2D-1B-GATE`もCI Run #269、Opus 4.8 review、人間確認を経て正式完了した。`2D-2-PROJECT + 2D-2-CREATE`はPR #93〜#101、Family / VariantはPR #117〜#122、`2D-2-RASTER + 2D-2-REPAIR`はPR #102〜#115、group 11 importはPR #124〜#144で現在契約範囲を完了した。Group 12は契約監査PR #146、計測準備PR #147、Pages分離PR #148 / #149、T1 Slice A PR #153、P1 Slice C PR #154、R1 Slice B1 PR #157、D1 PR #201、D2 PR #204、D3 PR #206をmainへ反映した。D3の最終head `ac84b8c`に対するCI Run #610と固定headの3方向独立reviewは全成功した。ADR-2026-07-29-031でD4のA1+B1+C1を承認し、製品実装は本docs-only決定PRのmerge後に別Draft PRで行う。正式B0、H3数値budget、B2、物理iPhone Safari、Group 12完了判定は保留する。

D1〜D3は`implemented / CI-passed / independently-verified / merged`である。D4は`contract accepted / product implementation not started`である。B2、物理iPhone Safari、Group 12完了判定は未完了のまま維持する。
