...
| 15 | `2D-4-CORE` + `2D-4-SHEET` + `2D-4-SCALE` | 共通export core、決定的再出力、fixed grid sheet、packed atlas、trim、padding、multi-page、1x / 2x / 3x、scale、extrudeを固定する。 | Fable5契約固定 + Codex + Opus 4.8 必須 review | 9、14 | SHEET実装後にSCALEへ進む。 | accepted: G15-C1 A + G15-C2 A + G15-C3 A / implemented: 2D-4-CORE + 2D-4-SHEET / CI-passed / independently-verified / merged / in-progress: 2D-4-SCALE / CI-pending | PR #229 / #231 / #232 / #233 / #235 / #236をmainへ反映した。PR #236最終head `d3a178b5614a00f72f1bd0e706b95e28d4c5189b`、merge `4d55e898d78729c92fd4c9c55188edaa64eba8e5`、CI Run #716（Actions ID `31510296044`）は全job成功し、SHEET/CORE/Playwright artifactと固定headの3方向read-only確認（`BLOCKER 0 / MUST 0`）を記録した。既存Atlas `0.1.0`、legacy ZIP、現行の理由付き拒否は維持する。進捗は16/27のまま。 |
