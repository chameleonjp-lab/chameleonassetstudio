...
PC、iPhone / iPad Safari、VoiceOver、実メモリ、GPU、Files、オフラインcacheは未確認である。CI完了後もGroup 21Cは`implemented-candidate / CI-passed / runtime-verification-unverified`とし、進捗は18/27のまま維持する。