...
| 14 | `2D-3-PREVIEW` + `2D-3-IMPACT` | 接地、origin、anchor、collider、tile、背景、gimmick、effectのゲーム風previewと、source変更影響の列挙を実装する。 | Codex + Opus 4.8 必須 review | 13 | 2D-4 fixture設計と並行可 | contract-audit-ready | Group 13 completed。one-sheet handoffを作成し、人間またはFable承認後だけ製品実装を開始する。 |
