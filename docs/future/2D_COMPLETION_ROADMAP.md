...
| 14 | `2D-3-PREVIEW` + `2D-3-IMPACT` | 接地、origin、anchor、collider、tile、背景、gimmick、effectのゲーム風previewと、source変更影響の列挙を実装する。 | Codex + Opus 4.8 必須 review | 13 | 2D-4 fixture設計と並行可 | accepted / not-started / unverified | Group 13 completed。2026-08-09に人間が`G14-P1 + G14-I1 + G14-U1`を承認し、one-sheetをacceptedとして同期する。製品実装は同期PRのmain反映後、別branch・別Draft PR・単一writerで開始する。 |
