...
PR #203 merge `73f0eafe69dd42c820f92e9f039e49fe2e2d9d28`でD2のmerge前Gateは満了し、PR #204 merge `eeaea39522d0f31bfe786ca0da27176bfd5ee859`でD2を`implemented / CI-passed / independently-verified / merged`としてcloseoutした。D3は契約承認済みだが製品実装は開始していない。D4、B2、物理iPhone SafariのGroup 12 closeout Gateは未完了のまま維持する。
