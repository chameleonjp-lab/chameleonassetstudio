...
| 12 | `2D-3-TIMELINE` + `2D-3-RIG` | frame animation、onion skin、可変時間、loop、event、part parent、pivot、bind pose、rotation / scale、part replace、簡易rig、frame bake、rig flipを実装する。 | Codex。新しいデータ意味はFable5または人間判断 | 8B、関連2D-1A契約 | 2D-2 と条件付き並行可 | public service + Slice A/C/B1 merged + D1 in Draft verification / B2 and D2-D4 pending | 契約監査PR #146、計測資産PR #147、Pages配信PR #148 / #149、T1 Slice A PR #153 merge `e8fac95`、P1 Slice C PR #154 merge `1c700e7`をmainへ反映した。2026-07-23の人間判断で正式B0の4端末収集を保留し、H3を問題発生時の診断手段へ切り替えた。ADR-2026-07-24-027でA1を採用し、PR #157 final head `834cc38`、merge `bf13cac`、CI Run #501全成功、非GitHub・非Opusの固定head独立review `BLOCKER 0 / MUST 0 / SHOULD 0`としてB1を完了した。B2のH3数値、資源上限、実機product-path、Group 12完了判定は保留する。ADR-2026-07-27-028でA1+B1を採用し、D1だけを実装・検証中とする。D2〜D4は後続判断まで未着手とする。正本は`2D_3_TIMELINE_RIG_PLAN.md`と`2D_3_H3_MEASUREMENT_PROTOCOL.md`。ADR-0010のcollider override / polygonはGroup 13へ残す。 |
