...
> **Group 12:** T1 / R1 / P1とH1=E1 / H2=L1 / H3=M1はaccepted。H3の数値budgetは`2D_3_H3_MEASUREMENT_PROTOCOL.md`による実測と後続人間承認まで未決定で、製品実装は未着手である。
...
> 境界はADR-0008 / 0009 / 0011、Group 12の実装契約はT1 / ADR-0021、派生exportはH1=E1で決定済み。製品実装は別の明示指示とPRを必要とする。

- 将来の`Frame.durationMs?: number`は有限かつ0より大きいms値とし、不在時は`1000 / animation.fps`を使う。
