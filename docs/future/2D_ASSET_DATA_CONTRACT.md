...
> **Group 12:** T1 / R1 / P1とH1=E1 / H2=L1 / H3=M1はaccepted。T1 Slice Aは本実装PRで可変時間、event、時間consumer統一、H1=E1拒否を検証中である。R1 / P1とH3の数値budgetは後続に残す。
...
> 境界はADR-0008 / 0009 / 0011、Group 12の実装契約はT1 / ADR-0021、派生exportはH1=E1で決定済み。T1 Slice Aは本実装PRで検証し、Atlas形式拡張とTimelineのevent編集は後続へ残す。
