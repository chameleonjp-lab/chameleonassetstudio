...
> **Group 12:** T1 / R1 / P1の中核契約はADR-0021〜0023でaccepted。派生export、Layer所属、rig bake上限のH1〜H3は`2D_3_TIMELINE_RIG_PLAN.md`で人間判断待ちであり、製品実装は未着手である。
...
> 境界はADR-0008 / 0009 / 0011、Group 12の実装契約はT1 / ADR-0021で決定済み。製品実装はH1決定後の別PRとする。
...
- 固定fpsしか表現できない派生exportへ、可変時間やeventを黙って均一化・削除しない。初期挙動はGroup 12計画H1で人間が決める。
