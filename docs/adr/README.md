...
| [0022](./0022-rig-flip-and-bake-parity.md) | rig flipの鏡映式・完全ID map・bake同値、H2=L1 / H3=M1境界 | Group 12計画 R1 / §6.4・§8.3 | ADR-2026-07-24-027でB1先行を承認。B1製品PRで追加 |
