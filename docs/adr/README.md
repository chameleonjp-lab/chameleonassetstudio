...
| [0021](./0021-frame-duration-semantics.md) | Frame単位可変時間、旧fps-only互換、H1=E1拒否 | Group 12計画 T1 / §8.2 | 将来のT1実装sliceで追加 |
