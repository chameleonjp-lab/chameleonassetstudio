...
| `2D-2` | 新規作成・取り込み・修正 | 複数Asset、空キャンバス、template、画像import、基本描画、非破壊修正、variant、一括変更、任意形式とAI境界を完成させる。独立Asset管理、残るCREATE A+B+X slice、RASTER Slice 1、REPAIR Slice 2、Variant / Batch group 10は完了した。 | Codex | 現在の段階。group 11は契約PR #124、Slice A PR #125、provenance基盤のSlice B PR #126、連番・手動格子・preview・quarantineのSlice C PR #127/#128、Tileset + Chameleon Atlas意味上roundtripのSlice D PR #129とcloseout PR #133、Slice E source MIME / Asset 0.2.0契約補正PR #135をmainへ反映済み。2026-07-21 acceptedの1A + 2A + 3A / ADR-0020に従い、SVG / GIF / APNG rasterized importとunsupported表示を製品実装中。 |
