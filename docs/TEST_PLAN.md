...
### 3.2 Group 12 Timeline / Rig計測・実装Gate（T1 Slice A / P1 Slice C / R1 Slice B1 / D1実装済み、B2保留、D2契約済み・実装前）
...
| Slice D2 | 再生順の前後1出現、loop端、反復Frame、赤系の「前」・青系の「次」、固定25%、UI-only state | 375 × 667で初期off、前・次の個別切替、再生中非表示、停止後復元、Asset / History不変、reloadでoff、44px、横overflowなし | 物理iPhone SafariはGroup 12 closeoutへ残す |
