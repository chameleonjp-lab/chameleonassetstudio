      ...
      parts: [
        {
          ...
          name: 'arm_left',
          partType: 'arm_left',
          layerIds: ['layer_pixel'],
          pivot: { x: 35, y: 27 },
          bindPose: {
            localPosition: { x: 2, y: -1 },
            localRotation: 4,
            localScale: { x: -0.9, y: 1.2 },
          },
          rotationLimit: { min: -35, max: 40 },
        },
      ],
      anchors: [],
      colliders: [],
          ...
          keyframes: [
            {
              ...
              poses: {
                part_pixel: {
                  ...
                  localRotation: -20,
                  localScale: { x: -1.1, y: 0.8 },
                },
              },
            },
            {
              time: 0.5,
              poses: { part_pixel: { localRotation: 17 } },
            },
            {
              time: 1,
              poses: {
                part_pixel: {
                  localPosition: { x: 5, y: -4 },
                  localRotation: 31,
                  localScale: { x: 0.6, y: -1.4 },
                },
              },
            },
          ],
